...
```text
Автоматическое выполнение без проверки и подтверждения может привести к применению некорректных конфигураций. Это может вызвать удаление ресурсов, конфликту настроек и т.д.
Ключ -auto-approve может пригодиться для запуска автоматизированных процедур, например CI/CD. Но только после успешного тестирования.
```
